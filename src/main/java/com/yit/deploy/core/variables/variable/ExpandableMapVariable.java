...
public class ExpandableMapVariable<T> extends BaseVariable<T> {

    public final MapVariable<T> variable;

    public ExpandableMapVariable(MapVariable<T> variable) {
        this(variable, null, null);
    }

    public ExpandableMapVariable(MapVariable<T> variable, VariableName name, String id) {
        super(name, id);
     ...
     */
    @Override
    public ExpandableMapVariable<T> name(@Nonnull VariableName name) {
        if (Objects.equals(this.name, name)) {
            return this;
        }
        return new ExpandableMapVariable<>(variable, name, id);
    }
    ...
    public VariableInfo toInfo() {
        return new VariableInfo(name, id, VariableType.expandableMap, variable.toInfo());
    }
}
